 ...
 *  Scanner.java</a> (NB: Java 6u23 and earlier uses only \n, \r, \r\n).
 *
...
public final class In {
    ...
    /**
     * Returns true is this input stream exists.
     *
    ...
    public char readChar() {
        ...
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'char' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public String readString() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'String' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public int readInt() {
        try {
            ...
            throw new InputMismatchException("attempts to read an 'int' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read an 'int' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public double readDouble() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'double' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'double' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public float readFloat() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'float' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'float' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public long readLong() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'long' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'long' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public short readShort() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'short' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'short' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public byte readByte() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'byte' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'byte' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
    ...
    public boolean readBoolean() {
        try {
            ...
            throw new InputMismatchException("attempts to read a 'boolean' value from the input "
                                           + "stream, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'boolean' value from the input "
                                           + "stream, but no more tokens are available");
        }
    }
     ...
     *
     * @return all remaining tokens in this input stream, as an array of integers
     */
     ...
     *
     * @return all remaining tokens in this input stream, as an array of longs
     */
     ...
     *
     * @return all remaining tokens in this input stream, as an array of doubles
     */
    ...
    /**
     * Reads all integers from standard input and returns them as
     * an array of integers.
     *
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new In("/home/wind/Coding/AlgorithmsInJava/data/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new In("G:\\www\\introcs\\stdlib\\InText.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
