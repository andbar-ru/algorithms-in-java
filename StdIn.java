 ...
 *  </ul>
 *  <p>
 *  The first three methods read all of remaining token on standard input
 ...
 *       input from only standard input. It is suitable for use before
...
public final class StdIn {
     ...
     *
     * @return {@code true} if standard input is empty (except possibly for whitespace);
    ...
    public static char readChar() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'char' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static String readString() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'String' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static int readInt() {
        try {
            ...
            throw new InputMismatchException("attempts to read an 'int' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read an 'int' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static double readDouble() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'double' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'double' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static float readFloat() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'float' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'float' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static long readLong() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'long' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'long' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static short readShort() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'short' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'short' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static byte readByte() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'byte' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'byte' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    public static boolean readBoolean() {
        try {
            ...
            throw new InputMismatchException("attempts to read a 'boolean' value from standard "
                                           + "input, but the next token is \"" + token + "\"");
        }
        catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'boolean' value from standard "
                                           + "input, but no more tokens are available");
        }
    }
    ...
    // do this once when StdIn is initializated
    static {
        resync();
    }
