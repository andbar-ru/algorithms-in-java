 ...
 *  Execution:    java StdRandom N [SEED]
 ...
 *  %  java StdRandom 5
 *  seed = 1568106025920
 *  22 87.09336  true 9.09188 0 0 55303698589 BECDFGA
 *   8 83.99528 false 8.56160 2 0 61651437255 DEFBCAG
 *  31 59.58940 false 8.79035 0 0 99304350677 BCAGDEF
 *  99 19.43065  true 8.93845 0 0 50185235644 BCAEDFG
 *  81 35.04220  true 9.12308 3 0 96753645008 EDACFGB
 *
 *  % java StdRandom 5
 *  seed = 1568106613206
 *  52 37.70486  true 8.59047 2 1 35385604915 FAGDEBC
 *  93 46.96614  true 8.94649 1 1 20801925318 FGDCBAE
 *  76 34.45278 false 9.14542 1 0 42599800409 DEFGABC
 *  27 50.98613  true 8.86610 1 0 74155674180 CGBAEDF
 *  19 67.13337  true 9.09695 0 1 23392185347 EABFGCD
 *
 *  % java StdRandom 5 1568106613206
 *  seed = 1568106613206
 *  52 37.70486  true 8.59047 2 1 35385604915 FAGDEBC
 *  93 46.96614  true 8.94649 1 1 20801925318 FGDCBAE
 *  76 34.45278 false 9.14542 1 0 42599800409 DEFGABC
...
public final class StdRandom {
     ...
     * @throws IllegalArgumentException if sum of array entries if not (very nearly) equal to {@code 1.0}
     ...
     * @throws IllegalArgumentException if {@code a} if {@code null}
     */
    ...
    public static void shuffle(Object[] a, int lo, int hi) {
        ...
        for (int i = lo; i < hi; i++) {
            int r = i + uniform(hi-i); // between i and hi-i
            Object temp = a[i];
            a[i] = a[r];
            a[r] = temp;
        }
    ...
    public static int[] permutation(int n, int k) {
        ...
        for (int i = k; i < n; i++) {
            int r = uniform(i+1); // between k and n
            if (r < k) perm[r] = i;
        }
        return perm;
    }
